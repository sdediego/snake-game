...
var allGameImages = {
    ...
    bug : {
        NEUTRAL_BUG : './images/bug/apple.png',
        BIG_MEAL_BUG : './images/bug/watermelon.png',
        BENJAMIN_BUTTON_BUG : './images/bug/orange.png',
        SPEEDY_GONZALEZ_BUG : './images/bug/lemon.png',
        TORTOISE_BUG : './images/bug/pineapple.png',
        POISSON_BUG : './images/bug/grapes.png',
        CRAB_BUG : './images/bug/banana.png',
    },
};
